...
class Keyword:
    ...
    def render(keyword: str):
        ...
        fake_related_keywords = [
            {'keyword': f'related_{keyword}_{i}', 'papers': 20 - i} 
            for i in range(5)
        ]
    ...
    def render_overview():
        ...
        keyword_stats = {
            'keywords': ['machine learning', 'deep learning', 'neural networks', 
                        'computer vision', 'NLP', 'software testing', 
                        'cloud computing', 'agile development'],
            ...
            'connections': {
                ...
                'edges': [
                    {'source': 'machine learning', 'target': 'deep learning', 'weight': 45},
                    {'source': 'deep learning', 'target': 'neural networks', 'weight': 30},
                    {'source': 'computer vision', 'target': 'deep learning', 'weight': 25},
                    {'source': 'natural language processing', 'target': 'deep learning', 'weight': 20}
                ]
            },
            'yearly_top': {
                2023: [
        ...
        with tab2:
            ...
            with trend_col:
                growth_fig = Keyword._create_growth_chart(
                    keyword_stats['growth_rates']
                )
    ...
    def _create_growth_chart(growth_data):
        ...
        fig.add_trace(
            go.Bar(
                ...
                textposition='auto',
                marker_color=['rgba(44, 160, 44, 0.7)' if rate['growth_rate'] > 20
        ...
        fig.update_layout(
            ...
            plot_bgcolor='white',
            showlegend=False,
            margin=dict(t=50, l=50, r=50, b=100)  # Increased bottom margin for rotated labels
        )
