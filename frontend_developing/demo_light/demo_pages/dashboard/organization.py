...
class Organization:
    ...
    def render(organization: str):
        ...
        with left_col:
            ...
            with tab1:
                ...
                for area, color in zip(areas, colors):
                    fig.add_trace(
                        go.Bar(
                            name=area, x=years, y=area_data[area], marker_color=color
                        )
                    )
        ...
        with right_col:
            tab1, tab2 = st.tabs(
                ["Top Papers (recent 5 years)", "Top Authors (recent 5 years)"]
            )
            with tab1:
                top_papers = sorted(
                    org_stats["recent_papers"],
    ...
    def render_overview():
        ...
        with tab1:
            ...
            network_fig = Organization._create_collaboration_network(
                org_stats["collaborations"]
            )
    ...
    def _create_collaboration_network(collab_data):
        ...
        node_trace = go.Scatter(
            ...
            hovertext=[
                f"{node}<br>Papers: {G.nodes[node]['size']}" for node in G.nodes()
            ],
            marker=dict(
    ...
    def _create_publication_trend(trend_data):
        ...
        fig.update_layout(
            ...
            #     'xanchor': 'center'
            # },
            xaxis={"title": "Year", "gridcolor": "lightgray"},
            yaxis={
    ...
    def _create_top_orgs_chart(top_orgs_data):
        ...
        sorted_data = sorted(top_orgs_data, key=lambda x: x["papers"], reverse=True)[
            :10
        ]
        ...
        fig.update_layout(
            ...
            xaxis=dict(title="Organization", tickangle=45, tickmode="linear"),
