...
def render_search_results(query, filters=None):
    ...
    with col2:
        if selected_index is not None:
            ...
            st.markdown(f"**Conference:** {selected_paper['Conference']} {selected_paper['Year']}")
            st.markdown(f"**Citations:** {selected_paper['Citations']}")
            st.markdown("### Abstract")
            st.write("This is a sample abstract for the selected paper. It would contain a brief summary of the research work, methodology, and findings.")
